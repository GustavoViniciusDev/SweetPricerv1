...
export default function CalculateAndRegisterPricing({ auth, pricing }: PageProps) {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!isNaN(parseFloat(value))) {
            setPackagingCost(parseFloat(value));
        } else {
            setPackagingCost(0);
        }
    };
    ...
    const handleBlur = () => {
        if (packagingCost === 0 || isNaN(packagingCost)) {
            setPackagingCost(0);
        }
    };
                                    ...
                                    <div className="flex items-center border-b border-gray-200 pb-3">
                                        ...
                                        <div className="relative w-1/2">
                                            <Input
                                                ...
                                                readOnly
                                                className="cursor-not-allowed w-full pl-10 bg-gray-100 border border-gray-300 rounded-md p-3 text-right text-gray-800 placeholder-gray-400"
                                            />
                                    ...
                                    <div className="flex items-center border-b border-gray-200 pb-3">
                                        ...
                                        <div className="w-1/2">
                                            <Input
                                                ...
                                                className="cursor-not-allowed w-full bg-gray-100 border border-gray-300 rounded-md p-3 text-right text-gray-800 placeholder-gray-400"
                                            />
                                        </div>
                                    </div>
                                    <div className="flex items-center border-b border-gray-200 pb-3">
                                    ...
                                    <div className="flex items-center border-b border-gray-200 pb-3">
                                        ...
                                        <div className="relative w-1/2">
                                            <Input
                                                ...
                                                onBlur={handleBlur}
                                                className="w-full pl-10 bg-white border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 rounded-md p-3 text-right text-gray-800 placeholder-gray-400 shadow-sm"
                                            />
                                            <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600">R$</span>
                                        </div>
                                    </div>
